classdef spikeRasterPlot < matlab.graphics.chartcontainer.ChartContainer & ...
    ...
    properties
        ...
        % All trials in a cell array.
        AllTrialsCount (:,1) cell = cell.empty(0,1)
        ...
        % Decide whether to plot the output 
        PlotFlag (:,1) logical = true
    end
    ...
    methods (Access = protected)
        ...
        function update(obj)
            ...
            if ~isempty(obj.AllTrialsCount)
                ydata = obj.AllTrialsCount;
                ax.YAxis.Categories = ydata;
                ax.YAxis.TickLabels = [];
                ax.YAxis.Limits = categorical(ydata([1 end]));
            else
